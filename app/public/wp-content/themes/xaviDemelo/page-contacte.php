                ...
                <div class="contenedor">
                    <div class="contacte__contenedor">
                        <div class="contacte__content">
                            <h1 class="hero__content--title" id="title">Contacta'ns</span></h1>   
                            <p>Si tens dubtes sobre algun espectacle o taller, si vols contractar-ne algun o senzillament vols més informació envia’ns un missatge i ens posarem en contacte amb com més aviat millor.</p>
                        </div>
